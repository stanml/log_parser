require_relative '../../lib/log_parser/regex_parser'
require_relative '../../lib/log_parser/file_parser'
...
describe FileParser do
  ...
  describe '#parse_file' do
    context 'when a file path and parser are supplied' do
      ...
      let(:result) do
        {
          test_argument1: %w[test_pattern_a test_pattern_d],
          test_argument2: %w[test_pattern_b test_pattern_e],
          test_argument3: ['test_pattern_c']
        }
      end
